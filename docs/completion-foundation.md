...
than being reported as an uncommitted failure. Repeating DELETE retries failed
or pending cleanup without duplicating deletion metadata or audit evidence.
...
database with migrations `0001` through `0018` already applied. For plain local
